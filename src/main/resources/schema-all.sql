CREATE USER IF NOT EXISTS SA SALT 'fcea1e13b9ddf489' HASH
'1f8d89b013b01262d3a8d493949ecc2ee7a8f7ff492b758017c55a20b0e890d2' ADMIN;
DROP TABLE IF EXISTS PUBLIC.GENRES;
DROP TABLE IF EXISTS PUBLIC.AUTHORS;
DROP TABLE IF EXISTS PUBLIC.BOOKS;
DROP TABLE IF EXISTS PUBLIC.AUTHOR_TO_BOOK_MAP;
...
ALTER TABLE PUBLIC.BOOKS
  ADD CONSTRAINT PUBLIC.CONSTRAINT_3C UNIQUE (TITLE);
ALTER TABLE PUBLIC.AUTHORS
  ADD CONSTRAINT PUBLIC.CONSTRAINT_44 UNIQUE (FULL_NAME);
ALTER TABLE PUBLIC.AUTHOR_TO_BOOK_MAP
